    ...
    return (
        <section className='bg-(--bg2)'>
            <div className='py-10 px-[5%] border-y border-y-(--border)'>
                ...
                <div className="section-tag inline-flex items-center bg-[rgba(108,99,255,0.1)] border border-[rgba(108,99,255,0.25)] rounded-full py-1 px-3.5 text-(--accent2) uppercase">⚡ How it Works</div>
