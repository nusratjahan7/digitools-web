...
const ModelHeder = () => {
    return (
        <div className='section-header text-center space-y-4'>
                <div className="section-tag inline-flex items-center bg-[rgba(108,99,255,0.1)] border border-[rgba(108,99,255,0.25)] rounded-full py-1 px-3.5 text-(--accent2) uppercase"><ShoppingBag className='mr-1.5'></ShoppingBag> Marketplace</div>
